        ...
        <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
          <View style={styles.welcomeSection}>
            <ThemedText style={styles.welcomeTitle}>
              Welcome back, {session?.displayName || 'Teacher'}!
            </ThemedText>
            <ThemedText style={styles.subtitle}>Manage your classes and engage with students.</ThemedText>
          </View>

          <View style={styles.placeholderContainer}>
            <Ionicons name="school" size={64} color={AdminColors.accent} style={{ opacity: 0.3 }} />
            <ThemedText style={styles.placeholderText}>Teacher dashboard content coming soon</ThemedText>
          </View>
        </ScrollView>
      </AdminLayout>
      ...
      >
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            <ThemedText style={styles.modalTitle}>Teacher Profile</ThemedText>
